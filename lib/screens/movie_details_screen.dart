...
class _MovieDetailsScreenState extends State<MovieDetailsScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      setState(() {
        ...
        _inWatchlist = ids.contains(widget.movieId);
      });
    } catch (e) {
  ...
  void _toggleWatchlist() {
    ...
    if (ids.contains(widget.movieId)) ids.remove(widget.movieId); else ids.add(widget.movieId);
    _watchBox.put('ids', ids.toList());
    setState(() { _inWatchlist = ids.contains(widget.movieId); });
  }
                  ...
                  Row(
                    children: [
                      ...
                      ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(backgroundColor: _inWatchlist ? Colors.deepPurple : null),
                      ),
                    ],
                  ),
